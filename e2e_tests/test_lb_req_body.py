...
server_url_assert_token = b'http'+b'/e2e_serve'
...
class TestSuite:
    def test_img_data(self):
        ...
        assert r.text == hashlib.md5(server_url_assert_token + data).hexdigest()
    ...
    def test_json(self):
        ...
        assert r.text == hashlib.md5(server_url_assert_token + data.encode()).hexdigest()
    ...
    def test_json_gzip(self):
        ...
        assert r.text == hashlib.md5(server_url_assert_token + ziped_data).hexdigest()
