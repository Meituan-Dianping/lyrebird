...
def main():
    ...
    * start with multipart args
    ...
    parser.add_argument('--enable-multiprocess', dest='enable_multiprocess', type=bool, help='change event based on multithread to multiprocess(reply on redis)')
    ...
    if args.enable_multiprocess == True and compat_redis_check():
        custom_conf['enable_multiprocess'] = True
    elif args.enable_multiprocess == False:
